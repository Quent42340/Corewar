...
void Camera::update() {
	...
	if (Keyboard::isKeyPressed(Qt::Key_Up))    { m_angleV += 0.3f; angleChanged = true; }
	if (Keyboard::isKeyPressed(Qt::Key_Down))  { m_angleV -= 0.3f; angleChanged = true; }
	if (Keyboard::isKeyPressed(Qt::Key_Left))  { m_angleH -= 0.3f; angleChanged = true; }
	if (Keyboard::isKeyPressed(Qt::Key_Right)) { m_angleH += 0.3f; angleChanged = true; }
